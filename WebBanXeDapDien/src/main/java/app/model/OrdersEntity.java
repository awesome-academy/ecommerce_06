...
public class OrdersEntity {
    ...
    private Set<OrdersDetailsEntity> ordersDetails = new HashSet<>(0);

    public Set<OrdersDetailsEntity> getOrdersDetails() {
        return ordersDetails;
    }

    public void setOrdersDetails(Set<OrdersDetailsEntity> ordersDetails) {
